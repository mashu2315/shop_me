  ...
  const Hero = ({handleOrderPopup}) => {
    ...
    return (
      <div className='relative overflow-hidden min-h-[550px] sm:min-h-[650px] bg-gray-100 flex justify-center items-center dark:bg-slate-950 dark:text-white duration-300'>
        <div className='h-[700px] w-[750px] bg-primary/40  absolute -top-1/2 right-0 rounded-3xl rotate-45 '>
          ...
          <Slider {...setting}>
              {
                ...
                return  <div key={data.id}>
                    <div className='grid grid-cols-1 sm:grid-cols-2'>
                       ...
                       className='relative z-10'><img src={data.img} alt="Slider Images" className='w-[300px] h-[300px] sm:h-[450px] sm:w-[450px] sm:scale-105 lg:scale-120 object-contain mx-auto'/></div>
                        </div>
                    </div>
                  </div>
                })
